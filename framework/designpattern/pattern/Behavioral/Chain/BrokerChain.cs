...
namespace DesignPattern.Behavioral.Chain.Broker
{
    public class BrokerChain : IDesignPatternDemo
    {
        public string Title => "13.2";

        public string Description => "Chain - Event Broker Chain";
