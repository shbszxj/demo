...
namespace DesignPattern.Behavioral.Chain.MethodChain
{
    public class MethodChain : IDesignPatternDemo
    {
        public string Title => "13.1";

        public string Description => "Chain - Method Chain";
