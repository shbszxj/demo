...
namespace DesignPattern.Structural.Decorator.CodeBuilder
{
    public class CodeBuilderDecorator : IDesignPatternDemo
    {
        public string Title => "9.1";

        public string Description => "Decorator - CodeBuilder";
