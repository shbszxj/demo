...
namespace DesignPattern.Structural.Proxy.PropertyProxy
{
    public class PropertyProxy : IDesignPatternDemo
    {
        public string Title => "12.2";

        public string Description => "Proxy - Property Proxy";
